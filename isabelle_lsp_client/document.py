...
from lsp_client import TextDocument_DidChange_Request, ContentChange
...
class Document:
    ...
    Document model.
    """
    def __init__(self, isabelle: IsabelleClient, uri, text=None):
        """
        Constructor.
    ...
    def local_apply_change(self, change: ContentChange):
        """
    ...
    def local_apply_changes(self, changes: list[ContentChange]):
        """
    ...
    async def isabelle_apply_changes(self, changes: list[ContentChange]):
        """
    ...
    async def apply_changes(self, changes: list[ContentChange]):
        """
    ...
    async def move_caret(self, line: int = 0, character: int = 0):
        """
    ...
    async def move_caret_to_end(self):
        """
    ...
    def find_next(self, pattern: str,
                  start_line: int = -1,
                  start_character: int = -1) -> tuple[int, int]:
        """
    ...
    def theory_until_caret(self, separator="\n"):
        """
